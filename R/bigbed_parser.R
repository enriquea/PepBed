...
#' This function added to the bedframe the BED12 columns. Please Read
#' https://pgatk.readthedocs.io/en/latest/pgatk-formats.html#id1 for
#' more information.
#'
#' @param inputFile Bed Data frame
#'
#' @return Modified Bed DataFrame with annotated columns.
#'
#' @export

setBed12Columns <- function(inputBed){
    columns <-c("chrom","chromStart","chromEnd","name","score", "strand", "thickStart", "thickEnd", "reserved", "blockCount","blockSizes", "chromStarts")
    colnames(inputBed) <- columns
    return(inputBed);
}
